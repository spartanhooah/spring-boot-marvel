...
data class Comics(
     ...
     * available digitally.
     */
    @JsonProperty("digitalId") var digitalId: Int,

    /** The canonical title of the comic */
    @JsonProperty("title") var title: String,

    /** The number of the issue in the series (will generally be 0 for collection formats). */
    @JsonProperty("issueNumber") var issueNumber: Int,

    /**
     * If the issue is a variant (e.g. an alternate cover, second printing, or director's cut), a
     * text description of the variant.
     */
    @JsonProperty("variantDescription") var variantDescription: String,

    /** The preferred description of the comic. */
    @JsonProperty("description") var description: String,

    /** The date the resource was most recently modified. */
    @JsonProperty("modified") var modified: OffsetDateTime,

    /** The ISBN for the comic (generally only populated for collection formats). */
    @JsonProperty("isbn") var isbn: String,

    /** The UPC barcode number for the comic (generally only populated for periodical formats). */
    @JsonProperty("upc") var upc: String,

    /** The Diamond code for the comic. */
    @JsonProperty("diamondCode") var diamondCode: String,

    /** The EAN barcode for the comic. */
    @JsonProperty("ean") var ean: String,

    /** The ISSN barcode for the comic. */
    @JsonProperty("issn") var issn: String,

    /** The publication format of the comic e.g. comic, hardcover, trade paperback. */
    @JsonProperty("format") var format: String,

    /** The number of story pages in the comic. */
    @JsonProperty("pageCount") var pageCount: Int,

    /** A set of descriptive text blurbs for the comic. */
    @JsonProperty("textObjects") var textObjects: Array<TextObjects>,

    /** The canonical URL identifier for this resource. */
    @JsonProperty("resourceURI") var resourceUri: String,

    /** A set of public website URLs for the resource. */
    @JsonProperty("urls") var urls: Set<Url>,

    /** A summary representation of the series to which this comic belongs. */
    @JsonProperty("series") var series: Array<SeriesSummary>,

    /**
     * A list of variant issues for this comic (includes the "original" issue if the current issue
     * is a variant).
     */
    @JsonProperty("variants") var variants: Array<ComicsSummary>,

    /**
     * A list of collections which include this comic (will generally be empty if the comic's format
     * is a collection).
     */
    @JsonProperty("collections") var collections: Array<ComicsSummary>,

    /**
     * A list of issues collected in this comic (will generally be empty for periodical formats such
     * as "comic" or "magazine").
     */
    @JsonProperty("collectedIssues") var collectedIssues: Array<ComicsSummary>,

    /** A list of key dates for this comic. */
    @JsonProperty("dates") var dates: Array<OffsetDateTime>,

    /** A list of prices for this comic. */
    @JsonProperty("prices") var prices: Array<Price>,

    /** The representative image for this comic. */
    @JsonProperty("thumbnail") var thumbnail: Image,

    /** A list of promotional images associated with this comic. */
    @JsonProperty("images") var images: Array<Image>,

    /** A resource list containing the creators associated with this comic. */
    @JsonProperty("creators") var creators: ResourceList<CreatorSummary>,

    /** A resource list containing the characters which appear in this comic. */
    @JsonProperty("characters") var characters: ResourceList<CharacterSummary>,

    /** A resource list containing the stories which appear in this comic. */
    @JsonProperty("stories") var stories: ResourceList<StorySummary>,

    /** A resource list containing the events in which this comic appears. */
    @JsonProperty("events") var events: ResourceList<EventSummary>
) {
  @Suppress("unused")
  @JsonCreator
