...
data class Event(
    ...
    @JsonProperty("start") var start: OffsetDateTime,

    /** The date of publication of the last issue in this event. */
    @JsonProperty("end") var end: OffsetDateTime,
    ...
    @JsonProperty("comics") var comics: ResourceList<ComicsSummary>,
    ...
    @JsonProperty("series") var series: ResourceList<SeriesSummary>,
    ...
    @JsonProperty("next") var next: EventSummary,

    /** A summary representation of the event which preceded this event. */
    @JsonProperty("previous") var previous: EventSummary
) {
  @Suppress("unused")
  @JsonCreator
