...
data class Series(
    ...
    @JsonProperty("startYear") var startYear: Int,

    /** The last year of publication for the series (conventionally, 2099 for ongoing series). */
    @JsonProperty("endYear") var endYear: Int,
    ...
    @JsonProperty("next") var next: SeriesSummary,

    /** A summary representation of the series which preceded this series. */
    @JsonProperty("previous") var previous: SeriesSummary
) {
  @Suppress("unused")
  @JsonCreator
