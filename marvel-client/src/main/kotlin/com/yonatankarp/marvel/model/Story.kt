...
data class Story(
    ...
    @JsonProperty("characters") var character: ResourceList<CharacterSummary>,

    /** A resource list of creators who worked on this story. */
    @JsonProperty("creators") var creator: ResourceList<CreatorSummary>,

    /** A summary representation of the issue in which this story was originally published. */
    @JsonProperty("originalIssue") var originalIssue: ComicsSummary
) {
  @Suppress("unused")
  @JsonCreator
