...
class MarvelCharacterClientTest {
  ...
  fun `should GET character by id custom offset and limit`() {
    ...
    // When we call  the client
    val call =
        client.getCharacter(characterId, TIMESTAMP, API_KEY, HASH_CODE, CUSTOM_OFFSET, CUSTOM_LIMIT)
  ...
  fun `should GET events by character id with custom offset and limit`() {
    ...
    // When we call  the client
    val call =
        client.getEventsByCharacterId(
            characterId, TIMESTAMP, API_KEY, HASH_CODE, CUSTOM_OFFSET, CUSTOM_LIMIT)
  ...
  fun `should GET series by character id with custom offset and limit`() {
    ...
    // When we call  the client
    val call =
        client.getSeriesByCharacterId(
            characterId, TIMESTAMP, API_KEY, HASH_CODE, CUSTOM_OFFSET, CUSTOM_OFFSET)
  ...
  fun `should GET stories by character id with custom offset and limit`() {
    ...
    // When we call  the client
    val call =
        client.getStoriesByCharacterId(
            characterId, TIMESTAMP, API_KEY, HASH_CODE, CUSTOM_OFFSET, CUSTOM_LIMIT)
